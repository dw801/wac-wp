...
<!-- daw - wac begin 01.  Add value tag to secret key input box and get value for GET param rk -->			
					<input type='text' name='secretkey-<?php echo $i; ?>' id='secretkey-<?php echo $i; ?>' value='<?php echo $_GET['rk'] ?>' data-required="1" data-ajaxcheck="validatesecretkey" />
<!-- daw - wac end 01 -->
